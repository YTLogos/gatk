...
import org.broadinstitute.hellbender.tools.exome.convertbed.ConvertBedToTargetFile;
import org.broadinstitute.hellbender.tools.genome.SparkGenomeReadCounts;
...
public final class CalculateTargetCoverage extends ReadWalker {
    ...
    /**
     * Populate the map by initializing a read count data container for each target
     * @return never {@code null}.
     */
    ...
    public Object onTraversalSuccess() {
        ...
        readCountTableColumns.addAll(ReadCountDataFactory.getColumnsOfReadCountType(readCountType).names());
