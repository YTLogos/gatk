...
public class GenomeReadCountsSpark extends GATKSparkTool {
    ...
    private static final Logger logger = LogManager.getLogger(GenomeReadCountsSpark.class);
...
//      TODO: Add interval parameter for getParallelReads to subset to non-X/Y/MT/etc. regions - issue filed #287
        ...
        final Map<SimpleInterval, Long> byKey = reads.map(read -> GenomeReadCountsSpark.createKey(read, sequenceDictionary)).countByValue();
