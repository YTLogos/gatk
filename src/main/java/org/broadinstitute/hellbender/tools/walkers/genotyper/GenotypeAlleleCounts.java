...
public final class GenotypeAlleleCounts implements Comparable<GenotypeAlleleCounts> {
     ...
     */
    private GenotypeAlleleCounts(final int ploidy,
                                 final int index,
                                 final int... sortedAlleleCounts) {
    ...
    private GenotypeAlleleCounts(final int ploidy,
                                 final int index,
                                 final int[] sortedAlleleCounts,
                                 final int distinctAlleleCount,
                                 final double log10CombinationCount){
        this.ploidy = ploidy;
        this.index = index;
     ...
     */
    private int alleleIndexToRank(final int index,
                                  final int from,
                                  final int to) {
        if (to <= from) {
            return -from - 1;
    ...
    private void copyAlleleCountsByIndex(final int[] dest,
                                         final int offset,
                                         final int minimumAlleleIndex,
                                         final int maximumAlleleIndex) {
